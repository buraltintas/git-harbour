...
func (s *Server) widget(w http.ResponseWriter, r *http.Request) {
	...
	fmt.Fprintf(w, `<svg xmlns="http://www.w3.org/2000/svg" width="480" height="184" viewBox="0 0 480 184" role="img" aria-label="GitHarbour Arcade and PvP stats for @%s"><rect x=".5" y=".5" width="479" height="183" rx="8" fill="%s" stroke="%s"/><path d="M24 20h20v20H24zM29 25h10v10H29z" fill="%s"/><text x="54" y="35" fill="%s" font-family="system-ui,-apple-system,sans-serif" font-size="18" font-weight="700">GitHarbour · @%s</text><text x="24" y="66" fill="%s" font-family="system-ui,-apple-system,sans-serif" font-size="14">Arcade · %s · %d rating · %dW / %dL</text><text x="24" y="88" fill="%s" font-family="system-ui,-apple-system,sans-serif" font-size="12">%d games · %.0f%% accuracy</text><text x="24" y="119" fill="%s" font-family="system-ui,-apple-system,sans-serif" font-size="14">PvP · %s · %d rating · %dW / %dL</text><text x="24" y="141" fill="%s" font-family="system-ui,-apple-system,sans-serif" font-size="12">%d games · %.0f%% accuracy</text><text x="24" y="168" fill="%s" font-family="system-ui,-apple-system,sans-serif" font-size="12">Your activity builds your fleet.</text></svg>`, escape(u.Login), bg, border, accent, text, escape(u.Login), muted, escape(u.Solo.Rank), u.Solo.Rating, u.Solo.Wins, u.Solo.Losses, muted, u.Solo.Games, u.Solo.Accuracy, text, escape(u.PVP.Rank), u.PVP.Rating, u.PVP.Wins, u.PVP.Losses, muted, u.PVP.Games, u.PVP.Accuracy, accent)
}
